...
cateringRouter.get("/", async (_req: Request, res: Response) => {
...
cateringRouter.post("/", async (req: Request, res: Response) => {
  const serviceResponse = await cateringServiceInstance.create(req.body);
  return handleServiceResponse(serviceResponse, res);
});

cateringRouter.put("/:id", async (req: Request, res: Response) => {
...
cateringRouter.delete("/:id", async (req: Request, res: Response) => {
